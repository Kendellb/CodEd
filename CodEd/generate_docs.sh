...
jsdoc model/user.js public/javascripts/editor.mjs model/editorModule.js model/editorModule.js public/javascripts/homepage.js public/javascripts/rollup.config.mjs 
